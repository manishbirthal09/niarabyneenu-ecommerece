...
export default function CategoryCarousel() {
  ...
  return (
    <section className="bg-white py-20 font-['Inter',system-ui,sans-serif] overflow-hidden">
      <style>{`
      ...
      <div className="mx-auto max-w-280 px-6">
        <div className="mb-11 flex items-baseline justify-between">
          <h2 className="m-0 font-['Cormorant_Garamond',serif] text-[1.9rem] font-semibold tracking-[0.02em] text-[#16271C]">
            Shop by category
          </h2>
      ...
      <div
        ...
        className={`cc-track mx-auto flex max-w-280 select-none gap-6 overflow-x-auto px-6 scrollbar-none [scroll-snap-type:x_mandatory] ${
      ...
      >
        {categories.map((cat) => (
          <a
            ...
            onClick={onCardClick}
            className="cc-card block w-[min(320px,78vw)] flex-none snap-start"
          >
            <div className="relative aspect-3/4 w-full overflow-hidden rounded bg-[#EDE6DB]">
              <img
                ...
                alt={cat.name}
                draggable={false}
                className="block h-full w-full object-cover transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]"
              />
              <div className="absolute inset-0 bg-linear-to-t from-[rgba(20,14,10,0.55)] via-transparent to-transparent" />
              <span className="cc-label absolute bottom-5.5 left-5 font-['Cormorant_Garamond',serif] text-[1.07rem] font-semibold uppercase tracking-[0.12em] text-[#FBF7F2]">
                {cat.name}
              </span>
            </div>
          </a>
